...
export default function Dashboard() {
  ...
  const renderContent = () => {
    ...
    switch (activePage) {
      ...
      case "certification": return <Certification {...globalProps} />; 
  ...
  return (
    <div className="flex min-h-screen bg-[#f8fafc] selection:bg-orange-100 selection:text-orange-600">
      ...
      <Helmet>
        <title>LIFESHOP | {activePage.toUpperCase()}</title>
        <meta name="robots" content="noindex, nofollow" /> 
      </Helmet>

      {/* 🔹 SIDEBAR & NAVIGATION MOBILE INTERNE */}
      <SidebarDashboard 
        user={user}
        wallet={wallet}
      ...
      <div className="flex-1 flex flex-col min-w-0">
        ...
        {/* 📱 HEADER MOBILE (Logo centré/aligné, bouton burger retiré) */}
        <header className="lg:hidden flex items-center justify-start p-4 bg-slate-950 text-white shadow-xl sticky top-0 z-50">
          <div className="flex items-center gap-3">
            ...
            <h1 className="font-black text-xl tracking-tighter uppercase italic">Life<span className="text-orange-500">Shop</span></h1>
          </div>
        </header>
