...
import { produitsAdidas } from "../components/AdidasBoutique"; // 🔹 Assure-toi d'exporter produitsAdidas
import { FaFacebook, FaInstagram, FaWhatsapp } from "react-icons/fa";

export default function ProductAdidasDetails({ user }) {
  const { id } = useParams();
  const product = produitsAdidas.find((p) => p.id === Number(id));
    ...
    <div className="bg-gray-100 min-h-screen py-6">
      <div className="max-w-7xl mx-auto grid md:grid-cols-3 gap-6 px-4">
        ...
        <div className="bg-white p-6 rounded shadow">
          ...
          <div className="ml-3 line-through text-gray-400">{product.oldPrice}</div>
        ...
        <div className="bg-white p-6 rounded shadow">
          ...
          <div className="border p-4 rounded">
            ...
            <p className="mt-2 font-semibold">Adidas Official</p>
