...
export default function Accueil() {
  ...
  return (
    <div className="bg-gray-100 min-h-screen">
      ...
      {/* 🚀 NOUVEAU : Optimisation SEO (Helmet + Meta tags) */}
      <Helmet>
        <title>Rynek - Découvrez les meilleures boutiques en ligne</title>
        <meta name="description" content="Explorez les meilleures boutiques en ligne par catégorie sur Rynek. Téléphones, mode, électroménager et plus encore." />
        <link rel="canonical" href="https://www.rynek.com" />
        
        {/* Open Graph (Facebook, WhatsApp, LinkedIn) */}
        <meta property="og:type" content="website" />
        <meta property="og:title" content="Rynek - Découvrez les boutiques en ligne" />
        <meta property="og:description" content="Explorez les meilleures boutiques en ligne par catégorie sur Rynek." />
        <meta property="og:image" content="https://www.rynek.com/images/og-banner.jpg" /> {/* Pense à changer cette URL avec une vraie image */}
        <meta property="og:url" content="https://www.rynek.com" />

        {/* Twitter */}
        <meta name="twitter:card" content="summary_large_image" />
      </Helmet>

      {/* 🚀 NOUVEAU : Balise H1 indispensable pour le SEO (Invisible visuellement) */}
      <h1 className="sr-only">Rynek : La marketplace pour toutes vos boutiques en ligne</h1>

      <div className="max-w-[1600px] mx-auto py-6 px-4 flex flex-col lg:flex-row gap-5">
        
        {/* ASIDE GAUCHE (Desktop uniquement) */}
        ...
        <main className="flex-1 min-w-0 flex flex-col gap-12 pb-20">
          ...
          {/* 🚀 NOUVEAU : Menu Catégories pour Mobile & Tablette */}
              ...
              {categories.map((cat) => (
                <button
                  ...
                  className={`px-5 py-2.5 rounded-full text-sm font-bold whitespace-nowrap transition-all duration-300 ${
                    categorieActive === cat
                      ? "bg-[#e96711] text-white shadow-md scale-105"
        ...
        {/* ASIDE DROITE (Desktop uniquement) */}
