...
export default function Dashboard() {
  ...
  // ✨ PERSONNALISATION À LA CRÉATION DU COMPTE (Doit être définie AVANT le useEffect)
  ...
  return (
    <div className="flex min-h-screen bg-[#f8fafc] overflow-hidden font-sans selection:bg-orange-100 selection:text-orange-600">
      ...
      <div className="flex-1 flex flex-col min-w-0">
        ...
        {/* HEADER MOBILE */}
        <header className="lg:hidden flex items-center justify-between p-6 bg-white border-b border-gray-100 shadow-sm">
          <div className="flex items-center gap-3">
            <div className="w-8 h-8 bg-orange-500 rounded-lg shadow-sm"></div>
            <h1 className="font-black text-xl tracking-tighter uppercase italic">RYNEK</h1>
          </div>
          <button 
            onClick={() => setMenuOpen(true)}
            className="p-3 bg-gray-50 rounded-2xl text-gray-900 active:scale-90 transition-transform"
          >
            <Icons.Menu size={24} />
          </button>
        </header>
